...
```bash
git clone https://github.com/yourusername/greenkart-mern.git
cd greenkart-mern
...
Login with the demo account listed below 👇
## 📋 Table of Contents
...
- Image serving for product photos
- CORS configuration
...
### Home Page
![Home Page](https://via.placeholder.com/800x400/27ae60/ffffff?text=GreenKart+Home+Page)

### Products Page
![Products Page](https://via.placeholder.com/800x400/27ae60/ffffff?text=Products+Page)

### Shopping Cart
![Shopping Cart](https://via.placeholder.com/800x400/27ae60/ffffff?text=Shopping+Cart)
...
> ⚠️ Make sure you **create a `.env` file** in the `backend` directory using the provided `.env.example` file as reference. Do NOT upload your real `.env` file to GitHub.
...
To test the login functionality, use the following demo account:

**Email:** demo@example.com  
**Password:** Demo@123

> Note: Ensure this user is either seeded into the database or created manually before sharing.
## 🎯 Usage
